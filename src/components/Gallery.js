...
const Gallery = ({
	...
	const getItemWidth = useCallback(galleryWidth => (galleryWidth - (columnsCountProp - 1) * borderWidthProp) / columnsCountProp, [columnsCountProp, borderWidthProp, columnsCountProp]);
	...
	}, [galleryItemCountNumb, columnsCountProp, borderWidthProp, loaderFormatProp, aspectRatioProp, autoFillInProp, imagesMaxWidthProp, imagesMinWidthProp]);
	...
	return <Box {...rest}>
		<Box
          ...
          minmax(${strToNumb(imagesMinWidthProp)},
